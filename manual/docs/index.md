...
For INAV multi-mission files, `-mission-index` may be used to define which segment of a multi-mission file to use (1 based).
...
The optional CLI file will be parsed for `safehome` and `fwapproach` information.
